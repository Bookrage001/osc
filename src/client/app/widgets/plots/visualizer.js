...
module.exports = class Visualizer extends _plots_base {
    ...
    static defaults() {
        ...
        return super.defaults({
            ...
            logScale: {type: 'boolean|number', value: false, help: 'Set to `true` to use logarithmic scale for the y axis (base 10). Set to a `number` to define the logarithm\'s base.'},
