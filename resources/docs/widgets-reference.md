...
| <h4 id="fader_steps">steps<a class="headerlink" href="#fader_steps" title="Permanent link">¶</a></h4> | `string`\|<br/>`number`\|<br/>`array` | <code>""</code> | Restricts the widget's value:<br/>- `auto`: use values defined in `range`<br/>- `number`: define a number of evenly spaced steps<br/>- `array`: use arbitrary values |
...
| <h4 id="knob_steps">steps<a class="headerlink" href="#knob_steps" title="Permanent link">¶</a></h4> | `string`\|<br/>`number`\|<br/>`array` | <code>""</code> | Restricts the widget's value:<br/>- `auto`: use values defined in `range`<br/>- `number`: define a number of evenly spaced steps<br/>- `array`: use arbitrary values |
...
| <h4 id="meter_steps">steps<a class="headerlink" href="#meter_steps" title="Permanent link">¶</a></h4> | `string`\|<br/>`number`\|<br/>`array` | <code>""</code> | Restricts the widget's value:<br/>- `auto`: use values defined in `range`<br/>- `number`: define a number of evenly spaced steps<br/>- `array`: use arbitrary values |
