...
| <h4 id="push_afterTouch">afterTouch<a class="headerlink" href="#push_afterTouch" title="Permanent link">#</a></h4> | `string` | <code>""</code> | Send afterTouch value to this osc address (between 0 and 1) |
